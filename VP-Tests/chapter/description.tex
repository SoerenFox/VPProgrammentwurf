...
%-----------------------------------------------------------------%
    %Test Case 11 - Verification of Makefile Encryption
%-----------------------------------------------------------------%
\section{TC-11 - Verification of Makefile Encryption}
...
\newpage
%-----------------------------------------------------------------%
    %Test Case 12 - Verification of Jump from Authenticator to Application
%-----------------------------------------------------------------%
\section{TC-12 - Verification of Jump from Authenticator to Application}
\label{sec:tc12}
...
%-----------------------------------------------------------------%
    %Test Case 13 - Verification of Buffer Overflow Protection
%-----------------------------------------------------------------%
\section{TC-13 - Verification of Buffer Overflow Protection}
\label{sec:tc13}
...
\newpage
%-----------------------------------------------------------------%
    %Test Case 14 - Verification of Stack Monitor Functionality
%-----------------------------------------------------------------%
\section{TC-14 - Verification of Stack Monitor Functionality}
\label{sec:tc14}
...
\begin{tabular}{|p{0.18\textwidth}|p{0.77\textwidth}|}
\hline
\textbf{Test Case ID} & TC-14 \\ \hline
...
%-----------------------------------------------------------------%
%Test Case 15 - Verification of Stack Corruption Detection
%-----------------------------------------------------------------%
\section{TC-15 - Verification of Stack Corruption Detection}
\label{sec:tc15}
...
\hline
\textbf{Test Case ID} & TC-15 \\ \hline
